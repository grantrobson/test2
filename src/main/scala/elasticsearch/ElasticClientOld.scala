...
//    httpRequest.asString
    ...
    val httpRequest = rq.postData(jsonToPost)
      .options(Seq(HttpOptions.method("POST")))
      .header("content-type","application/json")
    httpRequest.asString
  }
