...
class TaxCalculatorTest extends WordSpecLike with Matchers  {
  ...
  trait MockedTaxThresholdProvider1 extends TaxThresholdProvider {
  ...
  trait MockedTaxThresholdProvider2 extends TaxThresholdProvider {
    override def thresholds = Set(
  ...
  private val taxCalculatorWithMockedThresholds1 = new TaxCalculator with MockedTaxThresholdProvider1
  ...
  private val taxCalculatorWithMockedThresholds2 = new TaxCalculator with MockedTaxThresholdProvider2
